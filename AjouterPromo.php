...
<section class="portfolio_area portfolio_full p_100">
    ...
    <form name="F" method="post" action="AjouterProm.php">
        <h1 class="zzz">Ajouter Promotion</h1>
        <center>
            <div>
                <label>Nom Promotion </label></br>
                <input type="text" id="nom" name="nom" required="required">
            </div>

            <div>
                <label>Taux Promotion</label></br>
                <input type="number" id="taux" name="taux" required="required">
            </div>
            <div>
            ...
            <div>
                <label>Reference Produit</label></br>
                <select id="produit" name="produit">
                <?php
                    foreach($listeproduits as $row){
                ?>
                    <option value="<?PHP echo $row['refp']; ?>"><?PHP echo $row['nom']; ?></option>
                <?php
                    }
                ?>
                </select>
            ...
            <input type="submit" value="Ajouter Promotion " onclick="return verif()" />
        </center>
    </form>
