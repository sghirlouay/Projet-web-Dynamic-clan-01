...
<head>
    ...
    <title>Les Cartes Fidélité</title>
...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="afficherComptes.php"> <i class="menu-icon fa fa-dashboard"></i>Accueil </a>
                     ...
                     <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-bars"></i><a href="afficherComptes.php">Afficher les Comptes</a></li>
    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="afficherComptes.php">Accueil</a></li>
                            <li><a href="#">Gestion des données</a></li>
                            <li class="active">Gérer les Cartes </li>
                        </ol>
                    </div>
                </div>
            </div>
      ...
      <div id="afficher" >
        ...
        <table border="5" style="margin-right: 5px ;margin-left: 15px ;margin-top: 10px; background-color: #ff66b3">
    <tr>
        <td>Id carte</td>
        <td>Les Points Bonus</td>
